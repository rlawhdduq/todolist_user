...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("Select new todolist.user.dto.AuthUserDto(u.user_id, u.id, u.user_type, u.number_of_following, u.number_of_follower) From User as u Where u.id = :id")
    AuthUserDto getUserInfo(@Param("id") String user_id);
}
